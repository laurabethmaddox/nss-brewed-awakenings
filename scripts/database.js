...
*/
const database = { //Declare a variable named database
                    //that holds 3 objects of arrays 
    //Each array has different objects and their properties 
    //inside
    employees: [{
        id: 1,
        name: "Alphonse Meron",
...
//Export and declare a variable named getProducts that is
//equal to a function with no input parameters
export const getProducts = () => { 
    return database.products.map(product => ({...product}))
} //The function will return a copy of the products array that
//is inside the database variable by using the map method 
//to make a copy of the individual objects product

//Export and declare a variable named getEmployees that is
//equal to a function with no input parameters
export const getEmployees = () => {
    return database.employees.map(employee => ({...employee}))
} //The function will return a copy of the employees array that
//is inside the database variable by using the map method
//to make a copy of the individual objects employee

//Export and declare a variable named getOrders that is
//equal to a function with no input parameters
export const getOrders = () => {
    return database.orders.map(order => ({...order}))
} //The function will return a copy of the orders array that
//is inside the database variable by using the map method
//to make a copy of the individual objects order
